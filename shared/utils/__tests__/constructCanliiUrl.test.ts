...
describe("constructCanliiUrl", () => {
  ...
  it("should construct full URL when given a relative path starting with /en/", () => {
    ...
    const expected =
      "https://www.canlii.org/en/on/onltb/doc/2024/2024onltb2684/2024onltb2684.html";
  ...
  it("should throw error for invalid URL format", () => {
    ...
    expect(() => constructCanliiUrl(input, CANLII_BASE_URL)).toThrow(
      "Invalid CanLII URL format",
    );
  });
});
